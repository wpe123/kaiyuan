...
(function (A) {
	A.fn.prettyPhoto = function (W) {
		...
		W = jQuery.extend({animationSpeed:"normal", padding:40, opacity:0.8, showTitle:true, allowresize:true, counter_separator_label:"/", theme:"light_rounded", callback:function () {
		}}, W);
		...
		function P(d, c) {
			...
			return {width:imageWidth, height:imageHeight, containerHeight:V, containerWidth:Y, contentHeight:R, contentWidth:S, resized:hasBeenResized};
		}
		function T(d, c) {
